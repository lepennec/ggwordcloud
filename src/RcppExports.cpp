...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< IntegerVector >::type mask_group(mask_groupSEXP);
    Rcpp::traits::input_parameter< IntegerVector >::type angle_group(angle_groupSEXP);
    Rcpp::traits::input_parameter< int >::type max_angle_group(max_angle_groupSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(wordcloud_boxes(data_points, boxes, boxes_text, text_boxes, bigboxes, boxes_masks, boxes_mask, mask_boxes, mask_group, angle_group, max_angle_group, xlim, ylim, eccentricity, rstep, tstep, perc_step, max_steps, rm_outside, shape));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_ggwordcloud_wordcloud_boxes", (DL_FUNC) &_ggwordcloud_wordcloud_boxes, 20},
    {NULL, NULL, 0}
};
