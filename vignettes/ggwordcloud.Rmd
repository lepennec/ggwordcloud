...
Along this vignette, we will use a _lovely_ (and _thank you_) dataset: a collection of the word love (thank you) in several language combined with the number of native speakers of those language as well as the total number of speakers. The data have been extracted from _wikipedia_ and is exposed in two data frame of 4 columns: 
